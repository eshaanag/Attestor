...
| G' | PDF reporting + cached remediation | done (dry-run remediation) | `report/generate_pdf.py`, `report/remediation.py`; genuine Cisco report renders as a 2-page PDF with 9 failed controls, severity, device identity, framework mappings, and labelled dry-run remediation; `tests/test_pdf_report.py` |
