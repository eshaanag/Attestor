...
| H' | Minimal network ingestion dashboard | done (Cisco IOS scope) | `dashboard/app.py`, `tests/test_network_dashboard.py`; single/bulk genuine corpus uploads generate JSON/HTML/PDF; CIS and NIST-mapped views tested; invalid binary input produces error/no reports; full suite 40 passed |
