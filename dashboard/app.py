...
<div class="shell">
<header class="topbar">
  <a href="/" class="brand" style="text-decoration:none; color:inherit;"><div class="brand-mark">A</div><div><div class="brand-name">Attestor</div><div class="brand-subtitle">Network security compliance</div></div></a>
  <div class="status-pill"><span class="status-dot"></span>Local workspace</div>
</header>

<section class="hero">
  <div class="hero-copy"><div class="eyebrow">Audit console</div><h1>See what is secure before it becomes an incident.</h1><p>Upload a saved device configuration, evaluate a verified Cisco IOS, Junos, or FortiOS baseline, and leave with evidence your team can inspect offline.</p><div class="coverage"><span class="tag tag-active">Cisco IOS</span><span class="tag">Juniper Junos</span><span class="tag">Fortinet FortiOS</span><span class="tag">CIS + NIST mappings</span><span class="tag">Offline reports</span></div></div>
  <div class="hero-metric"><div class="metric-label">Verified controls</div><div class="metric-number">21</div><div class="metric-note">14 Cisco IOS controls, four Junos controls, and a three-control FortiOS subset. Broader coverage remains roadmap.</div></div>
</section>
...
<section class="panel">
  ...
  <form action="/api/network/audit" method="post" enctype="multipart/form-data">
    <div class="field"><label for="vendor">Vendor</label><select id="vendor" name="vendor"><option value="cisco_ios">Cisco IOS / IOS-XE (14 controls)</option><option value="juniper_junos">Juniper Junos (4-control verified subset)</option><option value="fortinet_fortios">Fortinet FortiOS (3-control verified subset)</option></select></div>
...
body{background:radial-gradient(circle at 14% 8%,rgba(0,0,0,.03),transparent 28%),radial-gradient(circle at 87% 22%,rgba(0,0,0,.02),transparent 25%),linear-gradient(145deg,#f9f9f9 0%,#fff 48%,#f2f2f2 100%);min-height:100vh;background-attachment:fixed}body:before{content:"";position:fixed;inset:0;pointer-events:none;background-image:linear-gradient(rgba(0,0,0,.03) 1px,transparent 1px),linear-gradient(90deg,rgba(0,0,0,.03) 1px,transparent 1px);background-size:46px 46px;mask-image:linear-gradient(to bottom,rgba(0,0,0,.52),transparent 76%)}.wrap{position:relative;z-index:1}.nav{position:relative;padding:10px 12px;border:1px solid rgba(255,255,255,.78);border-radius:14px;background:rgba(255,255,255,.52);box-shadow:0 14px 38px rgba(0,0,0,.04),inset 0 1px 0 rgba(255,255,255,.95);backdrop-filter:blur(18px) saturate(145%);-webkit-backdrop-filter:blur(18px) saturate(145%)}.mark{background:rgba(0,0,0,.9);border:1px solid rgba(255,255,255,.34);box-shadow:0 8px 22px rgba(0,0,0,.2),inset 0 1px 0 rgba(255,255,255,.24)}.navbtn,.primary{background:rgba(0,0,0,.9)!important;color:#fff!important;border:1px solid rgba(255,255,255,.22);box-shadow:0 12px 24px rgba(0,0,0,.17),inset 0 1px 0 rgba(255,255,255,.23)}.btn{transition:transform .16s ease-out,box-shadow .16s ease-out,background .2s ease,color .2s ease,border-color .2s ease}.btn:hover{transform:translateY(-1px)}.primary:hover,.navbtn:hover{background:var(--blue)!important;border-color:var(--blue)!important}.secondary{color:#000!important}.secondary:hover{background:var(--blue-soft)!important;color:var(--blue)!important;border-color:var(--blue)!important}.secondary,.trust,.metric,.card{background:rgba(255,255,255,.55);border-color:rgba(255,255,255,.82);box-shadow:0 17px 42px rgba(0,0,0,.04),inset 0 1px 0 rgba(255,255,255,.95);backdrop-filter:blur(18px) saturate(145%);-webkit-backdrop-filter:blur(18px) saturate(145%)}.topology{border:1px solid rgba(255,255,255,.7);border-radius:26px;background:radial-gradient(circle at 50% 38%,rgba(255,255,255,.76),rgba(255,255,255,.24) 48%,rgba(0,0,0,.02));box-shadow:0 30px 70px rgba(0,0,0,.08),inset 0 1px 0 rgba(255,255,255,.92);backdrop-filter:blur(14px) saturate(135%);-webkit-backdrop-filter:blur(14px) saturate(135%)}.plane{background:rgba(250,250,250,.55);border-color:rgba(255,255,255,.9);box-shadow:0 22px 36px rgba(0,0,0,.06),inset 0 1px 0 #fff}.node{background:rgba(255,255,255,.77);border-color:rgba(255,255,255,.96);box-shadow:8px 11px 0 rgba(0,0,0,.04),0 14px 28px rgba(0,0,0,.06),inset 0 1px 0 #fff;backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px)}.n-core{background:rgba(0,0,0,.92);border-color:rgba(255,255,255,.3)}.metric,.card{position:relative;overflow:hidden}.metric:before,.card:before{content:"";position:absolute;inset:0 auto auto 0;width:64%;height:1px;background:linear-gradient(90deg,rgba(255,255,255,.95),transparent)}.trust{margin-bottom:64px}.icon,.pill{background:rgba(0,0,0,.04);border:1px solid rgba(0,0,0,.1)}@supports not ((backdrop-filter:blur(1px)) or (-webkit-backdrop-filter:blur(1px))){.nav,.secondary,.trust,.metric,.card,.topology,.node{background:#fcfcfc}}
/* Base geometry retained explicitly so the glass layer cannot change layout. */
.nav{display:flex;justify-content:space-between;align-items:center}.brand{display:flex;align-items:center;gap:11px}.navlinks{display:flex;gap:22px;align-items:center}.navlinks a{color:var(--muted);font-size:13px;text-decoration:none}.navbtn{color:#fff!important}.hero{display:flex;flex-direction:column;align-items:center;text-align:center;gap:30px;padding:50px 0 30px}.hero h1{font-size:clamp(32px,4.5vw,56px);line-height:1.05;max-width:850px;margin:0 auto;text-wrap:balance}.hero p{color:var(--muted);font-size:17px;max-width:650px;margin:0 auto;text-wrap:pretty}.actions{display:flex;justify-content:center;gap:12px;margin-top:10px;flex-wrap:wrap}.btn{display:inline-flex;align-items:center;justify-content:center;text-decoration:none;border-radius:8px;padding:12px 17px;font-size:13px;font-weight:750}.topology{position:relative;min-height:425px;display:grid;place-items:center;perspective:1050px}.scene{position:relative;width:min(100%,520px);height:370px;transform:rotateX(54deg) rotateZ(-24deg);transform-style:preserve-3d}.scene:before{content:"";position:absolute;inset:34px 20px 30px;background:linear-gradient(135deg,#f0f0f0 25%,transparent 25%) 0 0/27px 27px;opacity:.8;border:1px solid #ddd;box-shadow:20px 24px 0 rgba(0,0,0,.03),38px 44px 0 rgba(0,0,0,.02);transform:translateZ(-12px)}.plane{position:absolute;inset:0;transform:translateZ(0)}.link{position:absolute;height:3px;background:#000;transform-origin:left center}.l1{left:20%;top:51%;width:37%;transform:rotate(-23deg)}.l2{left:48%;top:49%;width:34%;transform:rotate(24deg)}.l3{left:46%;top:51%;width:33%;transform:rotate(77deg)}.l4{left:25%;top:52%;width:31%;transform:rotate(65deg)}.node{position:absolute;width:104px;height:72px;padding:10px;border-radius:8px;transform:translateZ(26px);font-size:10px}.node:after{content:"";position:absolute;left:13px;right:13px;bottom:9px;height:4px;background:#eee;border-radius:3px}.node strong{display:block;font-size:11px}.node span{display:block;color:var(--muted);margin-top:3px}.n-core{left:39%;top:39%;width:118px;height:82px;color:#fff;transform:translateZ(54px)}.n-core span{color:#ccc}.n-core:after{background:#444}.n-edge{left:5%;top:18%}.n-router{right:2%;top:17%}.n-firewall{left:7%;bottom:8%}.n-cloud{right:2%;bottom:8%}.scene-label{position:absolute;right:11px;top:7px;transform:rotateZ(24deg) rotateX(-54deg);font-size:10px;letter-spacing:.08em;text-transform:uppercase;color:#000;font-weight:800}.signal{position:absolute;width:8px;height:8px;border-radius:50%;background:#000;z-index:4}.s1{left:47%;top:47%}.s2{left:73%;top:42%}.trust{padding:22px;border-radius:12px}.trust h2{font-size:16px;margin-bottom:14px}.trustrow{display:flex;gap:12px;padding:12px 0;border-top:1px solid #eee}.trustrow:first-of-type{border-top:0}.icon{width:30px;height:30px;display:grid;place-items:center;border-radius:8px;color:#000;font-weight:800;flex:none}.trustrow strong{display:block;font-size:13px}.trustrow span{display:block;color:var(--muted);font-size:12px;margin-top:2px}.metrics{display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin:4px 0 65px}.metric{border-radius:10px;padding:17px}.metric strong{display:block;font-size:25px;font-variant-numeric:tabular-nums}.metric span{display:block;color:var(--muted);font-size:11px;margin-top:3px;text-transform:uppercase;letter-spacing:.06em}.metric .accent{color:#000}.band{border-top:1px solid var(--line);padding-top:28px}.bandhead{display:flex;justify-content:space-between;align-items:end;gap:20px;margin-bottom:18px}.band h2{font-size:21px}.band p{color:var(--muted);font-size:13px}.cards{display:grid;grid-template-columns:repeat(3,1fr);gap:14px}.card{border-radius:10px;padding:19px;min-height:142px}.card strong{font-size:14px}.card p{color:var(--muted);font-size:12px;margin-top:6px}.pill{display:inline-block;margin-top:14px;border-radius:999px;padding:5px 8px;color:#000;font-size:10px;font-weight:800;text-transform:uppercase}.footer-note{color:var(--muted);font-size:12px;margin-top:23px}@media(max-width:900px){.hero{padding:50px 0 30px}.hero h1{font-size:clamp(32px,6vw,44px)}.hero p{font-size:16px}.topology{order:-1;min-height:350px}.metrics{grid-template-columns:repeat(2,1fr);margin-bottom:50px}.cards{grid-template-columns:repeat(2,1fr)}}@media(max-width:620px){.wrap{padding:20px 16px 45px}.navlinks a:not(.navbtn){display:none}.topology{min-height:300px;overflow:hidden}.scene{transform:scale(.78) rotateX(54deg) rotateZ(-24deg)}.cards{grid-template-columns:1fr}.hero{align-items:flex-start;text-align:left}.hero h1{font-size:38px;margin-left:0}.hero p{font-size:15px;margin-left:0}.actions{justify-content:flex-start}}@media(prefers-reduced-motion:reduce){*{scroll-behavior:auto!important}}
</style></head><body><div class="wrap"><nav class="nav"><a href="/" class="brand" style="text-decoration:none; color:inherit;"><img src="/logo.jpg" style="width:40px; height:40px; border-radius:8px; object-fit:contain;" alt="Attestor"><div><strong>Attestor</strong><small>Security compliance operations</small></div></a><div class="navlinks"><a href="#coverage">Coverage</a><a href="#trust">Trust model</a><a class="navbtn" href="/console">Open console</a></div></nav>
...
<script type="module">
  ...
  const initialTrafficValues = [420, 380, 290, 185, 156, 134];
  let traffic = defaultArcs.map((a, i) => ({ id: a.id, value: initialTrafficValues[i] || 100 }));

  const canvas = document.getElementById("cobe");
  const markersContainer = document.getElementById("cobe-markers-container");
  const trafficContainer = document.getElementById("cobe-traffic-container");
  ...
  defaultMarkers.forEach(m => {
    let pyramidHtml = '';
    for (let i = 0; i < 4; i++) {
      pyramidHtml += `<div class="cobe-pyramid-face" style="border-bottom: 13px solid ${colors[i]}; transform: ${transforms[i]}"></div>`;
    }
    markersHtml += `
      <div class="cobe-marker" id="marker-${m.id}" style="
        position-anchor: --cobe-${m.id};
        opacity: var(--cobe-visible-${m.id}, 0);
        filter: blur(calc((1 - var(--cobe-visible-${m.id}, 0)) * 8px));
      ">
        <div class="cobe-pyramid-container">${pyramidHtml}</div>
        <span class="cobe-region-label">${m.region}</span>
      </div>
    `;
  });
  if (markersContainer) markersContainer.innerHTML = markersHtml;
  ...
  const renderTraffic = () => {
    ...
    traffic.forEach(t => {
      trafficHtml += `
        <div class="cobe-traffic-label" id="traffic-${t.id}" style="
          position-anchor: --cobe-arc-${t.id};
          opacity: var(--cobe-visible-arc-${t.id}, 0);
          filter: blur(calc((1 - var(--cobe-visible-arc-${t.id}, 0)) * 8px));
        ">${t.value}k req/s</div>
      `;
    });
    if (trafficContainer) trafficContainer.innerHTML = trafficHtml;
  };
  if (trafficContainer) renderTraffic();

  // Update traffic values periodically
  setInterval(() => {
    ...
    traffic.forEach(t => {
      const el = document.getElementById(`traffic-${t.id}`);
      if (el) el.innerHTML = `${t.value}k req/s`;
    });
  }, 250);
  ...
  if (canvas) {
    ...
    function initGlobe() {
      ...
      globe = createGlobe(canvas, {
        ...
        markers: defaultMarkers.map(m => ({ location: m.location, size: 0.012, id: m.id })),
        arcs: defaultArcs.map(a => ({ from: a.from, to: a.to, id: a.id })),
        arcColor: [0, 0, 0],
        arcWidth: 0.5,
        arcHeight: 0.25,
        opacity: 0.7,
...
.network-card-badge, .pulse-dot, .metric-badge {
  display: none !important;
}
.mark, .brand-mark {
...
.brand strong, .brand-name { display: block; font-size: 16px !important; font-weight: 700 !important; color: var(--ui-ink) !important; }
.brand small, .brand-subtitle { display: block; margin-top: 1px; font-size: 11px !important; color: var(--ui-muted) !important; }
...
</style></head><body><div class="shell"><header class="topbar"><a href="/" class="brand" style="text-decoration:none; color:inherit;"><img src="/logo.jpg" style="width:40px; height:40px; border-radius:8px; object-fit:contain;" alt="Attestor"><div><strong>Attestor</strong><small>Organization-defined adapters</small></div></a><nav class="nav"><a href="/training">Training Studio</a><a href="/console">Console</a></nav></header><main><div class="eyebrow">Low-code vendor onboarding</div><h1>Vendor profiles</h1><p class="sub">Published profiles can audit exact redacted line patterns. They remain organization-defined, not Attestor-verified vendor benchmarks.</p>{notice}<section class="panel">{rows}</section></main></div></body></html>"""
...
def _console_page(search: str = "", vendor: str = "all", status: str = "all") -> str:
    ...
    for record in records:
        ...
        vendor_initial = (
            ...
            else "F" if record.get("vendor_key") == "fortinet_fortios"
...
async def _audit_network_upload(
    ...
    engine = {
        "juniper_junos": "run_junos_audit.py",
        "fortinet_fortios": "run_fortios_audit.py",
    }.get(vendor, "run_audit.py")
    cmd = [
        sys.executable,
...
def _network_results_page(items: list[dict], framework: str) -> str:
    ...
    return PAGE_TEMPLATE.split("<body>", 1)[0] + "<body><div class=\"shell\">" + (
        '<header class="topbar"><a href="/" class="brand" style="text-decoration:none; color:inherit;"><div class="brand-mark">A</div><div><div class="brand-name">Attestor</div><div class="brand-subtitle">Network security compliance</div></div></a><div class="status-pill"><span class="status-dot"></span>Audit complete</div></header>'
...
async def audit_network_configs(
    ...
    if vendor == "fortinet_fortios" and paired_facts:
        return HTMLResponse(
            "Companion device facts are not implemented for the scoped FortiOS adapter",
            status_code=400,
        )
    if vendor not in {"cisco_ios", "juniper_junos", "fortinet_fortios"}:
    ...
    with tempfile.TemporaryDirectory(prefix="attestor-network-upload-") as temp_name:
        ...
        for upload in files:
            ...
            DEVICE_RECORDS[record_id] = {
                ...
                "filename": display_name,
                "vendor_key": vendor,
                "vendor": "Juniper" if vendor == "juniper_junos" else "Fortinet" if vendor == "fortinet_fortios" else "Cisco",
                "platform": "Junos" if vendor == "juniper_junos" else "FortiOS" if vendor == "fortinet_fortios" else "IOS/IOS-XE",
                "status": "queued",
                "summary": {},
                "controls": [],
                "history": [],
...
@app.get("/logo.jpg")
async def get_logo():
    logo_path = REPO_ROOT / "dashboard" / "logo.jpg"
    if logo_path.exists():
