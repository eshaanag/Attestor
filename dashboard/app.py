...
</style></head><body><div class="shell"><header class="topbar"><div class="brand"><img src="/logo.jpg" style="width:40px; height:40px; border-radius:8px; object-fit:contain;" alt="Attestor"><div><strong>Attestor</strong><small>Organization-defined adapters</small></div></div><nav class="nav"><a href="/training">Training Studio</a><a href="/console">Console</a></nav></header><main><div class="eyebrow">Low-code vendor onboarding</div><h1>Vendor profiles</h1><p class="sub">Published profiles can audit exact redacted line patterns. They remain organization-defined, not Attestor-verified vendor benchmarks.</p>{notice}<section class="panel">{rows}</section></main></div></body></html>"""
